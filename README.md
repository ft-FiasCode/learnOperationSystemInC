This repo contains a complete Operating Systems Laboratory Manual covering Linux administration, process management, CPU scheduling, synchronization, inter-process communication, file I/O, and memory management.

The labs are designed to provide hands-on practical experience using Ubuntu Linux and C programming, aligned with standard university OS curricula.
...
Tools: Terminal, Text Editor (VS Code / Nano / Vim)
